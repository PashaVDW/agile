    ...
    <div class="flex flex-col gap-2.5" id="sidebar_header">
        <div class="flex items-center gap-2.5 px-3.5 h-[70px]">
            ...
            <div class="menu menu-default grow" data-menu="true">
                <div class="menu-item grow" data-menu-item-offset="0, 15px" data-menu-item-placement="bottom-start"
            ...
            <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
               ...
               <span
                ...
                CRM
                                    ...
                                    <div class="menu-item flex-col-reverse" data-menu-item-toggle="accordion"
                                        ...
                                        <div
                                            class="menu-link py-2 px-2.5 rounded-md border border-transparent !menu-item-here:bg-transparent">
               <span class="menu-title text-2sm text-gray-600 menu-link-hover:text-gray-900">
                ...
                <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                                        ...
                                        <div class="menu-accordion gap-px">
                                            <div class="menu-item">
                                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                                   href="html/demo10/public-profile/profiles/gamer.html">
                 <span
                     class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                  Gamer
                 </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                                   href="html/demo10/public-profile/profiles/feeds.html">
                 <span
                     class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                  Feeds
                 </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                                   href="html/demo10/public-profile/profiles/plain.html">
                 <span
                     class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                  Plain
                 </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                                   href="html/demo10/public-profile/profiles/modal.html">
                 <span
                     class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                  Modal
                 </span>
              ...
              <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
               ...
               <span
                ...
                3 Columns
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/public-profile/projects/2-columns.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                2 Columns
               </span>
             ...
             <span
              ...
              Teams
                            ...
                            <div class="menu-item">
                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                   href="html/demo10/public-profile/network.html">
             <span
                 class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
              Network
             </span>
             ...
             <span class="menu-title text-2sm text-gray-600 menu-link-hover:text-gray-900">
              ...
              <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                                ...
                                <div class="menu-accordion gap-px">
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/public-profile/campaigns/card.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Campaigns - Card
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/public-profile/campaigns/list.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Campaigns - List
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/public-profile/empty.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Empty
               </span>
              ...
              <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
               ...
               <span
                ...
                User Profile
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/home/company-profile.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Company Profile
               </span>
               ...
               <span
                ...
                Settings - With Sidebar
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/home/settings-enterprise.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Settings - Enterprise
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/home/settings-plain.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Settings - Plain
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/home/settings-modal.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Settings - Modal
               </span>
             ...
             <span
              ...
              <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                                ...
                                <div class="menu-accordion gap-px ps-2.5">
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/billing/basic.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Billing - Basic
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/billing/enterprise.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Billing - Enterprise
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/billing/plans.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Plans
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/billing/history.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Billing History
               </span>
             ...
             <span
              ...
              <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                                ...
                                <div class="menu-accordion gap-px ps-2.5">
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/security/get-started.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Get Started
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/security/overview.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Security Overview
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/security/allowed-ip-addresses.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Allowed IP Addresses
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/security/privacy-settings.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Privacy Settings
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/security/device-management.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Device Management
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/security/backup-and-recovery.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Backup & Recovery
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/security/current-sessions.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Current Sessions
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/security/security-log.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Security Log
               </span>
             ...
             <span
              ...
              <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                                ...
                                <div class="menu-accordion gap-px ps-2.5">
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/members/team-starter.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Teams Starter
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/members/teams.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Teams
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/members/team-info.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Team Info
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/members/members-starter.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Members Starter
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/members/team-members.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Team Members
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/members/import-members.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Import Members
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/members/roles.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Roles
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/members/permissions-toggle.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Permissions - Toggler
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/members/permissions-check.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Permissions - Check
               </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                   href="html/demo10/account/integrations.html">
             <span
                 class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
              Integrations
             </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                   href="html/demo10/account/notifications.html">
             <span
                 class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
              Notifications
             </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                   href="html/demo10/account/api-keys.html">
             <span
                 class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
              API Keys
             </span>
             ...
             <span class="menu-title text-2sm text-gray-600 menu-link-hover:text-gray-900">
              ...
              <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                                ...
                                <div class="menu-accordion gap-px">
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/appearance.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Appearance
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/invite-a-friend.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Invite a Friend
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/account/activity.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Activity
               </span>
           ...
           <span
            ...
            <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                        ...
                        <div class="menu-accordion gap-px ps-7">
                            <div class="menu-item">
                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                   href="html/demo10/network/get-started.html">
             <span
                 class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
              Get Started
             </span>
             ...
             <span
              ...
              <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                                ...
                                <div class="menu-accordion gap-px ps-2.5">
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/network/user-cards/mini-cards.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Mini Cards
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/network/user-cards/team-crew.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Team Crew
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/network/user-cards/author.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Author
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/network/user-cards/nft.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                NFT
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/network/user-cards/social.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Social
               </span>
             ...
             <span
              ...
              <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                                ...
                                <div class="menu-accordion gap-px ps-2.5">
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/network/user-table/team-crew.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Team Crew
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/network/user-table/app-roster.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                App Roster
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/network/user-table/market-authors.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Market Authors
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/network/user-table/saas-users.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                SaaS Users
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/network/user-table/store-clients.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Store Clients
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/network/user-table/visitors.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Visitors
               </span>
             ...
             <span
              ...
              <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                                ...
                                <div class="menu-accordion gap-px ps-2.5">
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/authentication/classic/sign-in.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Sign In
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/authentication/classic/sign-up.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Sign Up
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/authentication/classic/2fa.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                2FA
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/authentication/classic/check-email.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Check Email
               </span>
               ...
               <span
                ...
                <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                                        ...
                                        <div class="menu-accordion gap-px ps-2.5">
                                            <div class="menu-item">
                                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                                   href="html/demo10/authentication/classic/reset-password/enter-email.html">
                 <span
                     class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                  Enter Email
                 </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                                   href="html/demo10/authentication/classic/reset-password/check-email.html">
                 <span
                     class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                  Check Email
                 </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                                   href="html/demo10/authentication/classic/reset-password/change-password.html">
                 <span
                     class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                  Change Password
                 </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                                   href="html/demo10/authentication/classic/reset-password/password-changed.html">
                 <span
                     class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                  Password is Changed
                 </span>
             ...
             <span
              ...
              <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                                ...
                                <div class="menu-accordion gap-px ps-2.5">
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/authentication/branded/sign-in.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Sign In
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/authentication/branded/sign-up.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Sign Up
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/authentication/branded/2fa.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                2FA
               </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                           href="html/demo10/authentication/branded/check-email.html">
               <span
                   class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                Check Email
               </span>
               ...
               <span
                ...
                <i class="ki-filled ki-up text-3xs hidden menu-item-show:inline-flex">
                                        ...
                                        <div class="menu-accordion gap-px ps-2.5">
                                            <div class="menu-item">
                                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                                   href="html/demo10/authentication/branded/reset-password/enter-email.html">
                 <span
                     class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                  Enter Email
                 </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                                   href="html/demo10/authentication/branded/reset-password/check-email.html">
                 <span
                     class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                  Check Email
                 </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                                   href="html/demo10/authentication/branded/reset-password/change-password.html">
                 <span
                     class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                  Change Password
                 </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                                   href="html/demo10/authentication/branded/reset-password/password-changed.html">
                 <span
                     class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
                  Password is Changed
                 </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                   href="html/demo10/authentication/welcome-message.html">
             <span
                 class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
              Welcome Message
             </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                   href="html/demo10/authentication/account-deactivated.html">
             <span
                 class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
              Account Deactivated
             </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                   href="html/demo10/authentication/error-404.html">
             <span
                 class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
              Error 404
             </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link py-2 px-2.5 rounded-md menu-item-active:bg-gray-100 menu-link-hover:bg-gray-100"
                                   href="html/demo10/authentication/error-500.html">
             <span
                 class="menu-title text-2sm text-gray-800 menu-item-active:font-medium menu-item-active:text-gray-900 menu-link-hover:text-pgray-900">
              Error 500
             </span>
        ...
        <div class="flex flex-center justify-between shrink-0 ps-4 pe-3.5 mb-3.5" id="sidebar_footer">
           ...
           Pro
                        ...
                        <div class="flex flex-col">
                            <div class="menu-item">
                                <a class="menu-link" href="html/demo10/public-profile/profiles/default.html">
            <span class="menu-icon">
            ...
            <span class="menu-icon">
             ...
             <i class="ki-filled ki-right text-3xs rtl:transform rtl:rotate-180">
                                ...
                                <div class="menu-dropdown menu-default light:border-gray-300 w-full max-w-[220px]">
                                    <div class="menu-item">
                                        <a class="menu-link" href="html/demo10/account/home/get-started.html">
              <span class="menu-icon">
              ...
              <span class="menu-icon">
               ...
               <span class="tooltip" data-tooltip-content="true">
                Payment and subscription info
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="html/demo10/account/security/overview.html">
              <span class="menu-icon">
               ...
               Security
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="html/demo10/account/members/teams.html">
              <span class="menu-icon">
               ...
               Members & Roles
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="html/demo10/account/integrations.html">
              <span class="menu-icon">
            ...
            <div class="flex items-center gap-1.5">
                <div class="dropdown" data-dropdown="true" data-dropdown-offset="10px, 15px"
                    ...
                    <button
                        class="dropdown-toggle btn btn-icon btn-icon-lg relative size-8 hover:bg-light hover:text-primary dropdown-open:bg-gray-200 text-gray-600">
         <span class="menu-icon">
