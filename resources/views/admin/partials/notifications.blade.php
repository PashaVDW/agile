...
>
  ...
  <div class="flex items-center gap-1.5">
                ...
                <div class="flex grow gap-2.5 px-5">
                  <div class="relative shrink-0 mt-0.5">
                    <img
                      ...
                      src="assets/media/avatars/300-4."
                    />
                    <span
                ...
                >
                  ...
                  <div class="flex flex-col gap-3.5 grow">
                    ...
                    >
                      <div class="flex flex-col">
                        <a
                          class="hover:text-primary-active font-medium text-gray-900 text-xs"
                          href="#"
                        >
                          Ronald Richards
                        </a>
                        <a
                          class="hover:text-primary-active text-gray-500 font-medium text-3xs"
                          href="#"
                        >
                      ...
                      <a
                        class="hover:text-primary-active text-gray-700 font-medium text-xs"
                        href="#"
                      >
                        Go to profile
                      </a>
              ...
              <div class="flex flex-col gap-5 pt-3 pb-4">
                    ...
                    <div class="flex items-center gap-2.5">
                      ...
                      >
                        ...
                        <div class="px-2.5 pb-2">
                          <a
                            class="font-medium block text-gray-700 hover:text-primary text-xs leading-4 mb-0.5"
                            href="#"
                          >
                            Geometric Patterns
                          </a>
                ...
                <div class="flex grow gap-2.5 px-5">
                  ...
                  <div class="flex flex-col gap-2.5 grow">
                    ...
                    >
                      <i
                        class="ki-filled ki-user-tick text-success text-base"
                      ></i>
                ...
                <div class="flex grow gap-2.5 px-5">
                  ...
                  <div class="flex flex-col gap-2.5 grow">
                    ...
                    <div class="flex flex-wrap gap-2.5">
                      ...
                      <button class="btn btn-dark btn-sm">Go to profile</button>
                    </div>
                  </div>
                </div>
                <div class="border-b border-b-gray-200"></div>
    ...
    <a
      class="btn btn-icon btn-icon-lg size-8 hover:bg-light hover:text-primary text-gray-600"
      href="html/demo10/authentication/classic/sign-in.html"
    >
