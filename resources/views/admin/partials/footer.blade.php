<footer class="footer">
  ...
  <div class="container-fixed">
    ...
    >
      ...
      <nav
        class="flex order-1 md:order-2 gap-4 font-normal text-2sm text-gray-600"
      >
        <a
          class="hover:text-primary"
          href="https://keenthemes.com/Concat/tailwind/docs"
        >
          Docs
        </a>
        ...
        <a
          class="hover:text-primary"
          href="https://keenthemes.com/Concat/tailwind/docs/getting-started/license"
        >
          FAQ
        </a>
