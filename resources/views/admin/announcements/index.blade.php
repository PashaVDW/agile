...
@section("content")
  <div class="container">
    <div class="min-w-full">
      <div
        class="py-2 grid grid-cols-3 gap-3 w-full max-w-6xl mx-auto items-center"
      >
        <div></div>
      ...
      >
        <div class="scrollable-x-auto">
          <table
            ...
            class="table table-auto border-gray-400"
        ...
        <div
          class="card-footer flex justify-between flex-col md:flex-row gap-3 text-gray-600 text-2sm font-medium mt-4"
        >
