        ...
        >
          ...
          <div class="flex flex-col gap-2.5" id="sidebar_header">
            <div class="flex items-center gap-2.5 px-3.5 h-[70px]">
              <a href="html/demo10/index.html"></a>
              <div class="menu menu-default grow" data-menu="true">
                <div
                  class="menu-item grow"
                  data-menu-item-offset="0, 15px"
                  data-menu-item-placement="bottom-start"
                  data-menu-item-toggle="dropdown"
                  data-menu-item-trigger="hover"
                >
                  <div
                    class="menu-label cursor-pointer text-gray-900 font-medium grow justify-between"
                  >
                  ...
                  <div class="menu-dropdown w-48 py-2">
                    ...
                    <div class="menu-item">
                      <a
                        class="menu-link"
                        href="html/demo10/authentication/get-started.html"
                        tabindex="0"
                      >
                        <span class="menu-icon">
            ...
            <div class="flex items-center gap-2.5 px-3.5">
              <!-- Input -->
              <a
                class="btn btn-dark btn-sm justify-center min-w-[198px]"
              ...
              <!-- End of Input -->
              <button
                class="btn btn-icon btn-dark btn-icon-lg size-8 hover:text-primary"
