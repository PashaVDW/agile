                            ...
                            <div class="mb-5">
                                ...
                                >
                                    <div class="menu-item">
                                        ...
                                        >
                                            <span
                                                class="menu-icon items-start text-lg text-gray-600 menu-item-active:text-gray-900"
                                            >
                                                <i class="ki-filled ki-home-3"></i>
                                            </span>
                                            <span
                                                class="menu-title text-sm text-gray-800 font-medium menu-item-here:text-gray-900"
                                            >
                                                Evenementen
                                            </span>
                                        </a>
