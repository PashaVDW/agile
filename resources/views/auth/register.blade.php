    ...
    <div class="card max-w-[370px] w-full">
        <form action="{{ route('register') }}" class="card-body flex flex-col gap-5 p-10" id="sign_up_form" method="POST">
            ...
            <div class="flex flex-col gap-1">
                ...
                @enderror
                <input class="input @error('email') border-red-500 @enderror" name="email" placeholder="email@email.com" type="email" value="{{ old('email') }}" required />
            </div>
            ...
            <div class="flex flex-col gap-1">
                ...
                <span class="text-danger text-sm">{{ $message }}</span>
                @enderror
                <div class="input @error('password_confirmation') border-red-500 @enderror" data-toggle-password="true">
